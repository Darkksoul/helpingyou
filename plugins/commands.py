...
async def start(client, message):
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
            ...
            InlineKeyboardButton('𝐌𝐨𝐯𝐢𝐞𝐬 𝐆𝐫𝐨𝐮𝐩', url='https://t.me/Devilservers'),
            InlineKeyboardButton('𝐂𝐡𝐚𝐧𝐧𝐞𝐥', url='https://t.me/Devilservers')
        ]]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('𝐔𝐩𝐝𝐚𝐭𝐞', url='https://t.me/Devilservers'),
            InlineKeyboardButton('𝐂𝐡𝐚𝐧𝐧𝐞𝐥', url='https://t.me/Devilservers')
        ], [
            InlineKeyboardButton('𝐃𝐞𝐭𝐚𝐢𝐥𝐬', url=''),        
            InlineKeyboardButton('𝐇𝐞𝐥𝐩', callback_data='help')          
        ], [
            InlineKeyboardButton('𝐒𝐮𝐩𝐩𝐨𝐫𝐭 𝐆𝐫𝐨𝐮𝐩', url='https://t.me/Devilservers')
        ], [
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('𝐔𝐩𝐝𝐚𝐭𝐞', url='hhttps://t.me/Devilservers'),
            InlineKeyboardButton('𝐂𝐡𝐚𝐧𝐧𝐞𝐥', url='https://t.me/Devilservers')
        ], [
            InlineKeyboardButton('𝐃𝐞𝐭𝐚𝐢𝐥𝐬', url=''),        
            InlineKeyboardButton('𝐇𝐞𝐥𝐩', callback_data='help')          
        ], [
            InlineKeyboardButton('𝐒𝐮𝐩𝐩𝐨𝐫𝐭 𝐆𝐫𝐨𝐮𝐩', url='hhttps://t.me/Devilservers')
        ], [
            InlineKeyboardButton('𝐈𝐧𝐥𝐢𝐧𝐞', switch_inline_query_current_chat=''),
            InlineKeyboardButton('𝐒𝐞𝐭𝐭𝐢𝐧𝐠𝐬', callback_data=f"setting")
        ]]
